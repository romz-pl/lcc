...
public:
  ...
  friend bool __attribute__((__unused__)) operator!=(const Constructable &c0,
...
__attribute__((__used__)) void CompileTest() {
...
//  {
//    lcc::SmallVector<To> Vector(Array);
...
//  }
//  {
//    lcc::SmallVector<To, 4> Vector(Array);
...
TEST(SmallVectorTest, ToVectorOf) {
  ...
  std::vector<From> StdVector = {From(to1), From(to2), From(to3)};
  {
    lcc::SmallVector<To> Vector = lcc::to_vector_of<To>(StdVector);
  ...
  {
    auto Vector = lcc::to_vector_of<To, 4>(StdVector);
