...
#include <lcc/alloc/AllocatorBase.h>
#include <lcc/alloc/MathExtras.h>
#include <algorithm>
#include <cassert>
#include <cstddef>
#include <cstdint>
...
operator new(size_t Size,
             lcc::BumpPtrAllocatorImpl<AllocatorT, SlabSize, SizeThreshold,
                                        GrowthDelay> &Allocator) {
  return Allocator.Allocate(Size, std::min((size_t)lcc::NextPowerOf2(Size),
                                           alignof(std::max_align_t)));
}
...
void operator delete(void *,
                     lcc::BumpPtrAllocatorImpl<AllocatorT, SlabSize,
                                                SizeThreshold, GrowthDelay> &) {
}
